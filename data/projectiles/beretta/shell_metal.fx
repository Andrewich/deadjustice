...
float3			GROUND_COLOR_MIN = float3( 5.0/255.0, 5.0/255.0, 7.0/255.0 );
float3			SPECULAR_COLOR_MIN = float3( 0.035, 0.035, 0.045 );
float3			SKY_COLOR_MAX = float3( 250.0/255.0, 250.0/255.0, 255.0/255.0 );
float3			GROUND_COLOR_MAX = float3( 160.0/255.0, 160.0/255.0, 165.0/255.0 );
float3			SPECULAR_COLOR_MAX = float3( 0.8, 0.8, 0.95 );

// constants

float3			SKY_COLOR = float3( 250.0/255.0, 250.0/255.0, 255.0/255.0 );
float3			GROUND_COLOR = float3( 160.0/255.0, 160.0/255.0, 165.0/255.0 );
float3			SPECULAR_COLOR = float3( 0.8, 0.8, 0.95 );
