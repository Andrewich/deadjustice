...
// DJ constants
// float3			SKY_COLOR_MIN = float3( 18.0/255.0, 18.0/255.0, 20.0/255.0 );
// float3			GROUND_COLOR_MIN = float3( 5.0/255.0, 5.0/255.0, 6.0/255.0 );
// float3			SPECULAR_COLOR_MIN = float3( 0.035, 0.035, 0.045 );

// float3			SKY_COLOR_MAX = float3( 183.0/255.0, 188.0/255.0, 202.0/255.0 );
// float3			GROUND_COLOR_MAX = float3( 52.0/255.0, 52.0/255.0, 61.0/255.0 );
...
float3			GROUND_COLOR_MAX = float3( 85.0/255.0, 85.0/255.0, 95.0/255.0 );
float3			SPECULAR_COLOR_MAX = float3( 0.35, 0.35, 0.45 );
