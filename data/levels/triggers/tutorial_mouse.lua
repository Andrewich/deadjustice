...
function this.mouse_task1( this )
	local nextRowY
	...
	nextRowY = this:addCenteredHelpText( commandStartTime, commandEndTime, "USE W,A,S,D KEYS TO MOVE HARLEY AROUND", 0.75 ) 
...
function this.mouse_task2( this )
	local nextRowY
	local startTime = this.startTime
	...
	-- pre-task briefing
	nextRowY = this:addCenteredHelpText( 0+startTime, 5+startTime, "YOU CAN CHANGE MOVEMENT SPEED TO SNEAKING", 0.75 ) 
	nextRowY = this:addCenteredHelpText( 0+startTime, 5+startTime, "WITH MODIFIER KEY", nextRowY ) 
	...
	-- parameters: time start, time end, text string, relative vertical position [0,1]
	-- function returns Y-coordinate of next row, so multiple rows can be added to same relative location
	nextRowY = this:addCenteredHelpText( commandStartTime, commandEndTime, "NOW TRY TO SNEAK FORWARD, PRESS AND HOLD", 0.75 ) 
	nextRowY = this:addCenteredHelpText( commandStartTime, commandEndTime, "LEFT SHIFT AND USE W KEY TO MOVE", nextRowY ) 

	-- acceptance text for this task
	nextRowY = this:addCenteredHelpText( acceptStartTime, acceptEndTime, "GOOD!", 0.75 ) 

	this:addTimerWaitCondition( function(this) 
		return hero:isSneaking() and hero:primaryState() == "WALKING"
		end, commandEndTime-this.acceptTime )
...
function this.mouse_task3( this )
	local nextRowY
	local startTime = this.startTime
	...
	-- parameters: time start, time end, text string, relative vertical position [0,1]
	-- function returns Y-coordinate of next row, so multiple rows can be added to same relative location
	nextRowY = this:addCenteredHelpText( commandStartTime, commandEndTime, "NOW TRY TO WALK FORWARD, PRESS CAPS LOCK TO", 0.75 ) 
	nextRowY = this:addCenteredHelpText( commandStartTime, commandEndTime, "TOGGLE BETWEEN RUN/WALK AND USE W,A,S,D TO MOVE", nextRowY ) 
...
function this.mouse_task4( this )
	local nextRowY
	local startTime = this.startTime
	...
	-- parameters: time start, time end, text string, relative vertical position [0,1]
	-- function returns Y-coordinate of next row, so multiple rows can be added to same relative location
	nextRowY = this:addCenteredHelpText( commandStartTime, commandEndTime, "USE MOUSE TO TURN HARLEY", 0.75 ) 
...
function this.mouse_task5( this )
	local nextRowY
	local startTime = this.startTime
	...
	-- pre-task briefing
	nextRowY = this:addCenteredHelpText( 0+startTime, 3+startTime, "X EXECUTES ROLL MANOUVER", 0.75 ) 
...
function this.mouse_task6( this )
	local nextRowY
	local startTime = this.startTime
	...
	-- parameters: time start, time end, text string, relative vertical position [0,1]
	-- function returns Y-coordinate of next row, so multiple rows can be added to same relative location
	nextRowY = this:addCenteredHelpText( commandStartTime, commandEndTime, "USE X COMBINED WITH MOVEMENT DIRECTION CONTROLS", 0.75 ) 
...
function this.mouse_task7( this )
	local nextRowY
	local startTime = this.startTime
	...
	-- parameters: time start, time end, text string, relative vertical position [0,1]
	-- function returns Y-coordinate of next row, so multiple rows can be added to same relative location
	nextRowY = this:addCenteredHelpText( commandStartTime, commandEndTime, "PRESS AND HOLD C TO CROUCH DOWN", 0.75 ) 

	-- acceptance text for this task
	nextRowY = this:addCenteredHelpText( acceptStartTime, acceptEndTime, "NOW, RELEASE C TO GET UP", 0.75 ) 
...
function this.mouse_task8( this )
	local nextRowY
	local startTime = this.startTime
	...
	nextRowY = this:addCenteredHelpText( commandStartTime, commandEndTime, "CLICK LEFT MOUSE BUTTON TO RAISE WEAPON UP", nextRowY ) 
	nextRowY = this:addCenteredHelpText( commandStartTime, commandEndTime, "AND CLICK AGAIN TO FIRE", nextRowY ) 
...
function this.mouse_task9( this )
	local nextRowY
	local startTime = this.startTime
	...
	-- parameters: time start, time end, text string, relative vertical position [0,1]
	-- function returns Y-coordinate of next row, so multiple rows can be added to same relative location
	nextRowY = this:addCenteredHelpText( commandStartTime, commandEndTime, "USE TAB KEY TO CHANGE WEAPON", 0.75 ) 
...
function this.mouse_task10( this )
	local nextRowY
	local startTime = this.startTime
...
function this.mouse_task11( this )
	local nextRowY
	local startTime = this.startTime
	...
	-- parameters: time start, time end, text string, relative vertical position [0,1]
	-- function returns Y-coordinate of next row, so multiple rows can be added to same relative location
	nextRowY = this:addCenteredHelpText( commandStartTime, commandEndTime, "USE R TO RELOAD YOUR WEAPON", 0.75 ) 
...
function this.mouse_task12( this )
	local nextRowY
	local startTime = this.startTime
	...
	-- parameters: time start, time end, text string, relative vertical position [0,1]
	-- function returns Y-coordinate of next row, so multiple rows can be added to same relative location
	nextRowY = this:addCenteredHelpText( commandStartTime, commandEndTime, "USE Z TO THROW A DECOY SHELL TO DISTRACT ENEMIES", 0.75 ) 
...
-- tutorial task: peek
function this.mouse_task13( this )
	local nextRowY
	local startTime = this.startTime
	...
	-- parameters: time start, time end, text string, relative vertical position [0,1]
	-- function returns Y-coordinate of next row, so multiple rows can be added to same relative location
	nextRowY = this:addCenteredHelpText( commandStartTime, commandEndTime, "PRESS AND HOLD Q OR E PEEK AROUND A CORNER", 0.75 ) 

	-- acceptance text for this task
	nextRowY = this:addCenteredHelpText( acceptStartTime, acceptEndTime, "GOOD! RELEASE Q OR E TO RETURN FROM PEEK", 0.75 ) 
...
function this.mouse_task14( this )
	local nextRowY
	local startTime = this.startTime
...
-- tutorial task: kick
function this.mouse_task15( this )
	local nextRowY
	local startTime = this.startTime
	...
	nextRowY = this:addCenteredHelpText( commandStartTime, commandEndTime, "USE CTRL KEY TO KICK ENEMIES", nextRowY ) 
...
-- tutorial task: punch
function this.mouse_task16( this )
	local nextRowY
	local startTime = this.startTime
	...
	-- parameters: time start, time end, text string, relative vertical position [0,1]
	-- function returns Y-coordinate of next row, so multiple rows can be added to same relative location
	nextRowY = this:addCenteredHelpText( commandStartTime, commandEndTime, "USE RIGHT MOUSE BUTTON TO PUNCH", 0.75 ) 
